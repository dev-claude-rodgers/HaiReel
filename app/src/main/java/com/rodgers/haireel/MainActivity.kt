...
import com.rodgers.haireel.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        isAuthenticated = savedInstanceState?.getBoolean("isAuthenticated", false) ?: false
    ...
    private fun setupTabs() {
        val fragments = listOf(
            ...
            com.rodgers.haireel.ui.ReportContainerFragment(),
            com.rodgers.haireel.ui.SettingsFragment()
        )
