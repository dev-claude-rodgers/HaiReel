...
internal fun DeliveryListFragment.showListActions() {
        ...
        divider()
        // ── 並べ替え・出発準備
        sectionLabel("並べ替え・出発準備")
        row("🕐", "時間帯順に並べ替え", "開始時刻・時間帯の早い順に自動で並べ替える") {
            viewModel.sortByTimeSlot()
            com.google.android.material.snackbar.Snackbar.make(
                binding.root, "時間帯順に並べ替えました", com.google.android.material.snackbar.Snackbar.LENGTH_SHORT
            ).show()
        }
