...
internal fun DailyReportFragment.showFareCalculationDialog() {
    ...
    fuelPricePerL     = com.rodgers.haireel.util.AppSettings.getFuelPricePerLiter(ctx)
    fuelEfficiencyKmL = com.rodgers.haireel.util.AppSettings.getFuelEfficiencyKmPerL(ctx)
    ...
    vehicleSpinner.onItemSelectedListener = object : android.widget.AdapterView.OnItemSelectedListener {
        override fun onItemSelected(parent: android.widget.AdapterView<*>?, view: View?, pos: Int, id: Long) {
            ...
            com.rodgers.haireel.util.AppSettings.setFuelPricePerLiter(ctx, price)
            com.rodgers.haireel.util.AppSettings.setFuelEfficiencyKmPerL(ctx, eff)
    ...
    fuelSaveBtn.setOnClickListener {
        ...
        when {
            ...
            e == null || e <= 0f -> fuelEffInput.error = "燃費を入力してください（0より大きい値）"
                ...
                com.rodgers.haireel.util.AppSettings.setFuelPricePerLiter(ctx, p)
                com.rodgers.haireel.util.AppSettings.setFuelEfficiencyKmPerL(ctx, e)
                fuelPrefs.edit().putString("vehicle_type", vehicleTypeName).putString("fuel_type_name", fuelTypeName).apply()
