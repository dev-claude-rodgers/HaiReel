...
class RouteJinWidget : AppWidgetProvider() {
    ...
    companion object {
        ...
        fun refresh(context: Context) {
            ...
            val ids = manager.getAppWidgetIds(ComponentName(context, RouteJinWidget::class.java))
            if (ids.isNotEmpty()) {
                RouteJinWidget().onUpdate(context, manager, ids)
            }
        }
        ...
        private fun buildViews(context: Context): RemoteViews {
            ...
            val views = RemoteViews(context.packageName, R.layout.widget_routejin)
