...
import com.rodgers.routist.model.VanLayout
import com.rodgers.routist.model.VanLayoutPin
import com.rodgers.routist.model.VanView
    ...
    private fun savePhotoWithPins() {
        ...
        try {
            ...
            view.pins.forEach { pin ->
                ...
                canvas.drawText(pin.orderLabel.toString(), x, y - (m.ascent + m.descent) / 2f, paint)
            }
            // ギャラリーに保存
    ...
    private fun renderLayout(layout: VanLayout) {
        ...
        ivPhoto.post {
            ...
            view.pins.forEach { pin ->
                ...
                val bmp = createPinBitmap(pin.orderLabel, groupColor, delivery.isCompleted, dp)
        ...
        val placedNums  = view.pins.sortedBy { it.orderLabel }.map { it.orderLabel }
